...
user in an INI file next to LaazarusPortable.exe called LazarusPortable.ini.
...
copy AppNamePortable.ini from this directory to LazarusPortable.ini next to
LazarusPortable.exe. The options in the INI file are as follows:
